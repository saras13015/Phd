...
!     *   'NO CHEMICAL SOLUTION IN REACTION_V FUNCTION, loop number= ' ,
!     *   IBOUCLE
!      END IF
!
!
...
!!         WRITE ( LOUT , * )
!         WRITE (*,*)
!     *   'CHEMICAL SOLUTION IN REACTION_V FUNCTION, loop number = ' , IBOUCLE
!      ENDIF
!
!
      IF ( ISTATE .LE. -2 ) THEN
...
!
         ...
         WDOT         = RPAR ( NWDOT + K - 1 )  ! wdot: [mol / (cm^3 * s)]
