...
!! Modeling, Simulation and Data Analysis (MSDA)\n
!! Université Mohammed VI Polytechnique (UM6P)
  subroutine euler_LLF_x ( thd , adi , grid , T , W_i , cp , ha , v , fl )
...
!! Modeling, Simulation and Data Analysis (MSDA)\n
!! Université Mohammed VI Polytechnique (UM6P)
  subroutine euler_LLF_y ( thd , adi , grid , T , W_i , cp , ha , v , fl )
...
!! Modeling, Simulation and Data Analysis (MSDA)\n
!! Université Mohammed VI Polytechnique (UM6P)
  subroutine euler_LLF_z ( thd , adi , grid , T , W_i , cp , ha , v , fl )
