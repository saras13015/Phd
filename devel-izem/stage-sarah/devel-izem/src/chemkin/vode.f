...
!!----- begin version 1 - original (do not care about H concentration for OH calculation) -----
...
!!!        END IF
!!----- end version 1 -----
!!----- begin version 2 (calculates OH from H molar concentration) -----
!!        IF ( CH > 1.0d-3 * SUMXCON ) THEN
!!          WRK1 = WB(3) + WF(5)+WF(5) + WF(12)+WF(12) + WB(8)
!!          WRK2 = WF3_COH + WF7_COH + WF8_COH
...
!!        END IF
!!----- end version 2 -----
!!----- begin version 3 - best version (calculates OH from H mass fraction) -----
...
!!        IF ( METHODE == 1 ) WF4_CH = 0.0d0
!!----- begin version 1 - older (use 1 or 2, not at the same time) -----
!!        A0 = ( WF1_CH + WF1_CH - WF4_CH ) * WF2_CO * WF3_COH
!!        A1 = WF2_CO * WF3_COH + ( WF2_CO + WF3_COH ) * WF4_CH
...
!!        END IF
!!----- end version 1 -----
!!----- begin version 2 - newer (use 1 or 2, not at the same time) -----
!        CALL SLAMBDA_COEFF (WF1_CH, WF2_CO, WF3_COH, WF4_CH, 
!     *                      A0, A1, A2, AA)
!        ! A2 /= 0 normally, it's zero if you have CO2 .AND CH2 = 0
!        ! AA CAN BE < 0, if T<Tc. Cf. CF_2013 for correction
