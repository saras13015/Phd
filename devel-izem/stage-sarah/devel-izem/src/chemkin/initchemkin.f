...
!
!
      LOGICAL UPASR !> IN - U-PaSR reactor model
!
!
...
!
!
      NEQ   = KK + 1 ! Number of equations for PSR model
      IF ( UPASR ) THEN
         NEQ   = 2 * NEQ ! Number of equations for U-PaSR model
      ENDIF
