...
!! Benguerir, Morocco
  ...
  subroutine plot_stat_var ( idnumber , inp , thd , adi , x , y , z , xt , yt , zt , &
                             dx_i , dy_i , dz_i , reyavg , favavg , stat )
...
!    if ( rank == rank_default ) write ( * , format ) 'variable #' , idnumber , ', plotting' , trim (name)
    ...
    ! statistical variables
       ...
       wrk1 (sx:ex,sy:ey,sz:ez) = favavg % ux (sx:ex,sy:ey,sz:ez)
       call f_domega ( inp , adi , dy_i , wrk1 , wrk2 )
       ...
       call f_dtheta ( inp , adi , y , wrk1 , wrk2 , wrk3 )
       ...
       call f_dmix ( inp , adi , y , wrk1 , wrk2 , wrk3 )
       call plot_stat_vtr ( adi % L_ref , wrk3 )
       ...
       call dvis_99 ( inp , adi , y , wrk1 , wrk2 )
       call plot_stat_vtr ( adi % L_ref , wrk2 )
       ...
       wrk = adi % rho_ref * adi % L_ref * adi % u_ref / adi % mu_ref
       wrk1 (sx:ex,sy:ey,sz:ez) = favavg % ux (sx:ex,sy:ey,sz:ez)
       call reynolds ( inp , adi , dy_i , wrk1 , wrk2 )
       call similarity_x ( inp , wrk2 )
       call plot_stat_vtr ( wrk , wrk2 )

    else if ( name == 'Index_quality' ) then

!       wrk = sqrt ( adi % mu_ref * adi % L_ref / ( adi % rho_ref * adi % u_ref ) ) ! dimensions verified
       wrk1 (sx:ex,sy:ey,sz:ez) = reyavg % nu (sx:ex,sy:ey,sz:ez)
       wrk2 (sx:ex,sy:ey,sz:ez) = stat % tke_dissip (sx:ex,sy:ey,sz:ez)
       call length_kolmogorov ( wrk1 , wrk2 , wrk3 )
       call filter_width ( 0 , dx_i , dy_i , dz_i , wrk4 )
       wrk5 (sx:ex,sy:ey,sz:ez) = 1.0_dp / ( 1.0_dp + 0.05_dp * ( wrk4 (sx:ex,sy:ey,sz:ez) &
                                / wrk3 (sx:ex,sy:ey,sz:ez) ) ** 0.5_dp )
       call similarity_x ( inp , wrk5 )
    ...
    ! other variables
       ...
       call vorticity ( dx_i , dy_i , dz_i , reyavg % ux , reyavg % vy , reyavg % wz , wrk1 )
       call similarity_x ( inp , wrk1 )
       call plot_stat_vtr ( adi % u_ref / adi % L_ref , wrk1 )

    else if ( name == 'fa_Vorticity' ) then

       call vorticity ( dx_i , dy_i , dz_i , favavg % ux , favavg % vy , favavg % wz , wrk1 )
       call similarity_x ( inp , wrk1 )
       call plot_stat_vtr ( adi % u_ref / adi % L_ref , wrk1 )
       ...
       call dy ( dy_i , favavg % ux , wrk1 )
       call comm_one (wrk1)
       call similarity_x ( inp , wrk1 )
       call plot_stat_vtr ( 1.0_dp / adi % time_ref , wrk1 )

    else if ( name == 'du1_x1' ) then

       call dx ( dx_i , favavg % ux , wrk1 )
       call comm_one (wrk1)
       call similarity_x ( inp , wrk1 )
       call plot_stat_vtr ( 1.0_dp / adi % time_ref , wrk1 )
       ...
       call comm_one (favavg % ux) ; call dy ( dy_i , favavg % ux , wrk1 )
    ...
    ! budget equations
       ...
       call tke_transport2 ( dx_i , dy_i , dz_i , stat % tke_transp , wrk1 )
       ...
       wrk = adi % rho_ref * adi % u_ref * adi % u_ref * adi % u_ref / adi % L_ref
       call rey_transport2 ( dx_i , dy_i , dz_i , stat % rey_transp_11 , wrk1 )
       wrk1 (sx:ex,sy:ey,sz:ez) = - wrk1 (sx:ex,sy:ey,sz:ez) ! transport is a negative term
       call similarity_x ( inp , wrk1 )
       call plot_stat_vtr ( wrk , wrk1 )
       ...
       wrk = adi % rho_ref * adi % u_ref * adi % u_ref * adi % u_ref / adi % L_ref
       call rey_transport2 ( dx_i , dy_i , dz_i , stat % rey_transp_22 , wrk1 )
       wrk1 (sx:ex,sy:ey,sz:ez) = - wrk1 (sx:ex,sy:ey,sz:ez) ! transport is a negative term
       call similarity_x ( inp , wrk1 )
       call plot_stat_vtr ( wrk , wrk1 )
       ...
       wrk = adi % rho_ref * adi % u_ref * adi % u_ref * adi % u_ref / adi % L_ref
       call rey_transport2 ( dx_i , dy_i , dz_i , stat % rey_transp_33 , wrk1 )
       wrk1 (sx:ex,sy:ey,sz:ez) = - wrk1 (sx:ex,sy:ey,sz:ez) ! transport is a negative term
       call similarity_x ( inp , wrk1 )
       call plot_stat_vtr ( wrk , wrk1 )
       ...
       wrk = adi % rho_ref * adi % u_ref * adi % u_ref * adi % u_ref / adi % L_ref
       call rey_transport2 ( dx_i , dy_i , dz_i , stat % rey_transp_12 , wrk1 )
       wrk1 (sx:ex,sy:ey,sz:ez) = - wrk1 (sx:ex,sy:ey,sz:ez) ! transport is a negative term
       call similarity_x ( inp , wrk1 )
       call plot_stat_vtr ( wrk , wrk1 )
       ...
       wrk = adi % rho_ref * adi % u_ref * adi % u_ref * adi % u_ref / adi % L_ref
       call rey_transport2 ( dx_i , dy_i , dz_i , stat % rey_transp_13 , wrk1 )
       wrk1 (sx:ex,sy:ey,sz:ez) = - wrk1 (sx:ex,sy:ey,sz:ez) ! transport is a negative term
       call similarity_x ( inp , wrk1 )
       call plot_stat_vtr ( wrk , wrk1 )
       ...
       wrk = adi % rho_ref * adi % u_ref * adi % u_ref * adi % u_ref / adi % L_ref
       call rey_transport2 ( dx_i , dy_i , dz_i , stat % rey_transp_23 , wrk1)
       wrk1 (sx:ex,sy:ey,sz:ez) = - wrk1 (sx:ex,sy:ey,sz:ez) ! transport is a negative term
       call similarity_x ( inp , wrk1 )
       call plot_stat_vtr ( wrk , wrk1 )
       ...
       call tke_mass_flux_coupl ( adi , dx_i , dy_i , dz_i ,  &
                                  wrk1 , wrk2 , wrk3 , wrk4 , &
                                  wrk_dim5 , wrk6 )
       ...
       call rey_mass_flux_coupl_11 ( adi , dx_i , dy_i , dz_i , &
                                     wrk1 , wrk4 ,              &
                                     wrk_dim5 , wrk6 )
       call similarity_x ( inp , wrk6 )
       call plot_stat_vtr ( wrk , wrk6 )
       ...
       call rey_mass_flux_coupl_22 ( adi , dx_i , dy_i , dz_i , &
                                     wrk1 , wrk4 ,              &
                                     wrk_dim5 , wrk6 )
       call similarity_x ( inp , wrk6 )
       call plot_stat_vtr ( wrk , wrk6 )
       ...
       call rey_mass_flux_coupl_33 ( adi , dx_i , dy_i , dz_i , &
                                     wrk1 , wrk4 ,              &
                                     wrk_dim5 , wrk6 )
       call similarity_x ( inp , wrk6 )
       call plot_stat_vtr ( wrk , wrk6 )
       ...
       call rey_mass_flux_coupl_12 ( adi , dx_i , dy_i , dz_i , &
                                     wrk1 , wrk2, wrk4 ,        &
                                     wrk_dim5 , wrk6 )
       call similarity_x ( inp , wrk6 )
       call plot_stat_vtr ( wrk , wrk6 )
       ...
       call tke_production ( dx_i , dy_i , dz_i , &
                             wrk1 , wrk2 , wrk3 , &
                             wrk4 , wrk5 , wrk6 , &
                             wrk7 , wrk8 , wrk9 , &
                             wrk10 )
       ...
       wrk7 (sx:ex,sy:ey,sz:ez) = stat % favvar_uxvy (sx:ex,sy:ey,sz:ez)
       wrk8 (sx:ex,sy:ey,sz:ez) = stat % favvar_uxwz (sx:ex,sy:ey,sz:ez)
       call rey_production_11 ( dx_i , dy_i , dz_i , &
                                wrk1 ,               &
                                wrk4 ,               &
                                wrk7 , wrk8 ,        &
                                wrk10 )
       ...
       wrk8 (sx:ex,sy:ey,sz:ez) = stat % favvar_uxwz (sx:ex,sy:ey,sz:ez)
       wrk9 (sx:ex,sy:ey,sz:ez) = stat % favvar_vywz (sx:ex,sy:ey,sz:ez)
       call rey_production_12 ( dx_i , dy_i , dz_i , &
                                wrk1 , wrk2 ,        &
                                wrk4 , wrk5 ,        &
                                wrk7 , wrk8 , wrk9 , &
                                wrk10 )
       ...
       wrk8 (sx:ex,sy:ey,sz:ez) = stat % favvar_uxwz (sx:ex,sy:ey,sz:ez)
       wrk9 (sx:ex,sy:ey,sz:ez) = stat % favvar_vywz (sx:ex,sy:ey,sz:ez)
       call rey_production_13 ( dx_i , dy_i , dz_i , &
                                wrk1 , wrk2 ,        &
                                wrk4 , wrk5 ,        &
                                wrk7 , wrk8 , wrk9 , &
                                wrk10 )
       ...
       wrk8 (sx:ex,sy:ey,sz:ez) = stat % favvar_uxwz (sx:ex,sy:ey,sz:ez)
       wrk9 (sx:ex,sy:ey,sz:ez) = stat % favvar_vywz (sx:ex,sy:ey,sz:ez)
       call rey_production_23 ( dx_i , dy_i , dz_i , &
                                wrk1 , wrk2 ,        &
                                wrk4 , wrk5 ,        &
                                wrk7 , wrk8 , wrk9 , &
                                wrk10 )
       ...
       call tke_convection ( dx_i , dy_i , dz_i , &
                             wrk2 , wrk3 , wrk4 , &
                             wrk5 , wrk1 , wrk6 )
       ...
       wrk4 (sx:ex,sy:ey,sz:ez) = favavg % vy (sx:ex,sy:ey,sz:ez)
       wrk5 (sx:ex,sy:ey,sz:ez) = favavg % wz (sx:ex,sy:ey,sz:ez)
       call rey_convection ( dx_i , dy_i , dz_i , &
                             wrk2 , wrk3 , wrk4 , &
                             wrk5 , wrk1 , wrk6 )
       wrk6 (sx:ex,sy:ey,sz:ez) = - wrk6 (sx:ex,sy:ey,sz:ez) ! LHS to RHS
       call similarity_x ( inp , wrk6 )
    ...
    else if ( name == 'VOR_Kappa_Production' ) then

       wrk = adi % u_ref * adi % mu_ref / ( adi % rho_ref * adi % L_ref * adi % L_ref * adi % L_ref )
       wrk1 (sx:ex,sy:ey,sz:ez) = stat % vor_volume (sx:ex,sy:ey,sz:ez)
       call similarity_x ( inp , wrk1 )
       call plot_stat_vtr ( wrk , wrk1 )
       
    else if ( name == 'VOR_Mu_Production' ) then

       wrk = adi % u_ref * adi % mu_ref / ( adi % rho_ref * adi % L_ref * adi % L_ref * adi % L_ref )
       wrk1 (sx:ex,sy:ey,sz:ez) = stat % vor_shear (sx:ex,sy:ey,sz:ez)
       call similarity_x ( inp , wrk1 )
       call plot_stat_vtr ( wrk , wrk1 )       
       ...
       call scal_var_mean_conv ( dx_i        , dy_i        , dz_i        , &
       ...
       wrk = adi % rho_ref * adi % u_ref / adi % L_ref
       call scal_var_turb_transp_last ( dx_i , dy_i , dz_i , stat % scal_var_turb_transp , wrk1 )
       ...
       call scal_var_turb_prod_last ( dx_i , dy_i , dz_i , stat % scal_var_turb_prod , wrk1 , wrk2 )
       ...
       call scal_var_mol_diff_last ( dx_i , dy_i , dz_i , stat % scal_var_mol_diff , wrk1 ) ! this variable has implicit sign
    ...
    ! correlations
       ...
       call integral_length_Z ( inp , xt , yt , zt , dz_i , stat % tmp_corr_ux , wrk1 )
       call similarity_x ( inp , wrk1 )
       call plot_stat_vtr ( adi % L_ref , wrk1 )
